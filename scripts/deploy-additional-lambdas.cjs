/**
 * Deploy additional Lambda functions (profiles, dashboard, billing)
 */
...
const DB_SECRET_ARN = 'arn:aws:secretsmanager:us-east-1:706704660887:secret:mentalspace-ehr-db-credentials-al4fLD';
const LAYER_ARN = 'arn:aws:lambda:us-east-1:706704660887:layer:DatabaseLayerB491180B:2';

const lambdas = [
  // Profiles
  { name: 'list-profiles', awsName: 'mentalspace-list-profiles', handler: 'index.handler', memory: 512, timeout: 30 },
  { name: 'get-profile', awsName: 'mentalspace-get-profile', handler: 'index.handler', memory: 512, timeout: 30 },
  { name: 'update-profile', awsName: 'mentalspace-update-profile', handler: 'index.handler', memory: 512, timeout: 30 },

  // Dashboard
  { name: 'get-dashboard-stats', awsName: 'mentalspace-get-dashboard-stats', handler: 'index.handler', memory: 512, timeout: 30 },

  // Billing
  { name: 'list-claims', awsName: 'mentalspace-list-claims', handler: 'index.handler', memory: 512, timeout: 30 }
];

console.log('🚀 Deploying additional Lambda functions...\n');
