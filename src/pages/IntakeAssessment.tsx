      ...
      if (cosignData) {
        ...
        toast({
          ...
          description: supervisorProfile 
            ? `Your note has been submitted to ${supervisorProfile.first_name} ${supervisorProfile.last_name} for review and co-signature.`
            : 'Your note has been submitted to your supervisor for review and co-signature.',
        });
      }
    } catch (error) {
